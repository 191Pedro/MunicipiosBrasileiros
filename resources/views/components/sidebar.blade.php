<aside id="sidebar" class="group/sidebar bg-bg-secondary dark:bg-bg-secondary-dark p-2 w-[260px] h-[calc(100dvh-60px)] sticky top-[60px] self-start duration-300 row-span-2">
    <section class="group/sidebar group-[.closed]/sidebar:px-2 px-4 bg-bg-tertiary dark:bg-bg-tertiary-dark h-full rounded-[24px] duration-300">
